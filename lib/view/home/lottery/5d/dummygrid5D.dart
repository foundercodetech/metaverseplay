                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: textWidget(text: list3[index],fontSize: widths*0.04,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                textWidget(text: listthree[index].type,fontSize: widths*0.04,color: Colors.grey),
                                textWidget(text: listthree[index].amount,fontSize: widths*0.04,color: Colors.grey),
                              ],
                            ),
                          ),
                        ),
                  ...
                  return Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: textWidget(text: listt[index].toString(),fontSize: widths*0.045,color: Colors.white),
                      ),
                      textWidget(text: list1[index].toString(),fontSize: widths*0.034,color: Colors.grey),
                    ],
                  );
                },
              ),
