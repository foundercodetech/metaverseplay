...
import 'package:metaverseplay/view/home/lottery/5d/commonbottomsheet5d.dart';
import 'package:metaverseplay/view/home/lottery/5d/dummygrid5D.dart';
import 'package:metaverseplay/view/home/lottery/5d/slotmachine.dart';
import 'package:metaverseplay/view/home/lottery/trx/imagetoastTRX.dart';
              ...
              Column(
                children: [
                      ...
                      children: List.generate(list.length, (index) {
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                selectedCatIndex == index ? Image.asset(Assets.imagesGoldentime, height: 70) : SvgPicture.asset(Assets.iconsTime, height: 70),
                                textWidget(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        textWidget(text: "Lotre \nResult",fontSize: widths*0.045,color: Colors.white),
                        Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                                    ...
                                    5,
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: textWidget(text: "1",fontSize: widths*0.034,color: Colors.black),
                                          ),
                                        ),
                                  )
                                ),
                                textWidget(text: "=",fontSize: widths*0.045,color: Colors.white),
                                CircleAvatar(
                                  radius: 20,
                                  backgroundColor: AppColors.goldencolortwo,
                                  child: textWidget(text: "10",fontSize: widths*0.04),
                                )
                              ],
                            ),
                            Row(
                                children: List.generate(
                                  Lotreresultalpha.length,
                                      ...
                                      Container(
                                        ...
                                        height: 30,
                                        alignment: Alignment.center,
                                        child: textWidget(text: Lotreresultalpha[index],fontSize: widths*0.034,color: Colors.white),
                                      ),
                                )
                            ),
                                      ...
                                      InkWell(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: textWidget(text: alphabetlist[index],fontSize: widths*0.04,
                                            ...
                                            Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: Row(
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: [
                                                    textWidget(text: SizeTypelist[index].type,fontSize: widths*0.04,color: Colors.grey),
                                                    textWidget(text: SizeTypelist[index].amount,fontSize: widths*0.04,color: Colors.grey),
                                                  ],
                                                ),
                                              ),
                                            ),
                                      ...
                                      return Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: textWidget(text: digitlist[index].digit.toString(),fontSize: widths*0.045,color: Colors.white),
                                          ),
                                          textWidget(text: digitlist[index].setdigit.toString(),fontSize: widths*0.034,color: Colors.grey),
                                        ],
                                      );
                                    },
                                  ),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: widths*0.14,),

                          Container(
                              height: heights*0.055,
                              width: widths*0.065,
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                      ...
                      Container(width: widths, color: AppColors.primaryContColor, height: 0.5),
                    ],
                  );
                },
              ),
