                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: textWidget(text: list3[index].toString(),fontSize: w*0.04,
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  textWidget(text: listthree[index].type,fontSize: w*0.04,color: Colors.white),
                                  textWidget(text: listthree[index].amount,fontSize: w*0.04,color: Colors.white),
                                ],
                              ),
                            ),
                          ),
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      textWidget(text: list1[index].toString(),fontSize: w*0.034,color: Colors.grey),
                    ],
                  );
                },
              ),
                        ...
                        Padding(
                          ...
                          child: Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: decrement,
                                  child: SvgPicture.asset(Assets.imagesReduce,height: 30,),
                                ),
                                Container(
                                    height: 35,
                                    alignment: Alignment.center,
                                ...
                                InkWell(
                                  onTap: increment,
                                  child: SvgPicture.asset(Assets.imagesAdd,height: 30,),
                                ),
                              ]),
                        ),
                      ],
