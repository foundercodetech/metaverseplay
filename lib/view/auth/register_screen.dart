...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  // TextEditingController refercodee = TextEditingController(text:"531530895570");
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      SvgPicture.asset(Assets.iconsEmailTabColor,height: 30,color: AppColors.goldencolortwo),
                      const SizedBox(width: 20),
                      textWidget(
                          text: 'Email',
                          fontWeight: FontWeight.w400,
